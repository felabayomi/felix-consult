      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <section className="max-w-3xl mb-16">
          ...
          <p className="text-gray-400 text-lg mb-6">
            Explore our app-foundry catalog: proven solution tracks you can launch, customize, or scale with us.
          </p>

          <p className="text-gray-500">
            Pick your closest fit, then we scope implementation based on your goals, timeline, and business model.
          </p>
        </section>
